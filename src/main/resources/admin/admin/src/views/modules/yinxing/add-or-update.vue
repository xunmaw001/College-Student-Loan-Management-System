<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="银行地址" prop="yinxingdizhi">
          <el-input v-model="ruleForm.yinxingdizhi" 
              placeholder="银行地址" clearable  :readonly="ro.yinxingdizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="银行地址" prop="yinxingdizhi">
              <el-input v-model="ruleForm.yinxingdizhi" 
                placeholder="银行地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="银行简介" prop="yinxingjianjie">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="银行简介"
                  v-model="ruleForm.yinxingjianjie" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yinxingjianjie" label="银行简介" prop="yinxingjianjie">
                    <span>{{ruleForm.yinxingjianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.mima = true;
          ...
          if(o=='yinxingdizhi'){
            this.ruleForm.yinxingdizhi = obj[o];
	    this.ro.yinxingdizhi = true;
            continue;
          }
          if(o=='yinxingdianhua'){
	    ...
	    this.ro.yinxingdianhua = true;
          ...
          if(o=='yinxingjianjie'){
            this.ruleForm.yinxingjianjie = obj[o];
	    this.ro.yinxingjianjie = true;
            continue;
          }
        }
      }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yinxing/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yinxingCrossAddOrUpdateFlag = false;
						 this.parent.search();
