<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="还贷编号" prop="haidaibianhao">
            <el-input v-model="ruleForm.haidaibianhao" 
                placeholder="还贷编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.haidaibianhao" label="还贷编号" prop="haidaibianhao">
              <el-input v-model="ruleForm.haidaibianhao" 
                placeholder="还贷编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="每月利息" prop="meiyuelixi">
          <el-input v-model="ruleForm.meiyuelixi" 
              placeholder="每月利息" clearable  :readonly="ro.meiyuelixi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="每月利息" prop="meiyuelixi">
              <el-input v-model="ruleForm.meiyuelixi" 
                placeholder="每月利息" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="贷款月数" prop="daikuanyueshu">
          <el-input v-model="ruleForm.daikuanyueshu" 
              placeholder="贷款月数" clearable  :readonly="ro.daikuanyueshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="贷款月数" prop="daikuanyueshu">
              <el-input v-model="ruleForm.daikuanyueshu" 
                placeholder="贷款月数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="还贷金额" prop="haidaijine">
            <el-input v-model="haidaijine"
                placeholder="还贷金额" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.haidaijine" label="还贷金额" prop="haidaijine">
              <el-input v-model="ruleForm.haidaijine" 
                placeholder="还贷金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="还贷时间" prop="haidaishijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.haidaishijian" 
                type="datetime"
                :readonly="ro.haidaishijian"
                placeholder="还贷时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.haidaishijian" label="还贷时间" prop="haidaishijian">
              <el-input v-model="ruleForm.haidaishijian" 
                placeholder="还贷时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="还贷进度" prop="haidaijindu">
          <el-select :disabled="ro.haidaijindu" v-model="ruleForm.haidaijindu" placeholder="请选择还贷进度">
            <el-option
                v-for="(item,index) in haidaijinduOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="还贷进度" prop="haidaijindu">
	      <el-input v-model="ruleForm.haidaijindu"
                placeholder="还贷进度" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  computed: {
    ...
    haidaijine:{
      get: function () {
        return 1*this.ruleForm.meiyuelixi*this.ruleForm.daikuanyueshu+parseFloat(this.ruleForm.daikuanjine==""?0:this.ruleForm.daikuanjine)
      }
    },
  },
  created() {
	this.ruleForm.haidaishijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='haidaibianhao'){
            this.ruleForm.haidaibianhao = obj[o];
	    this.ro.haidaibianhao = true;
            continue;
          }
	    ...
	    this.ro.daikuanjine = true;
          ...
          if(o=='meiyuelixi'){
            this.ruleForm.meiyuelixi = obj[o];
	    this.ro.meiyuelixi = true;
            continue;
          }
          if(o=='daikuanyueshu'){
            this.ruleForm.daikuanyueshu = obj[o];
	    this.ro.daikuanyueshu = true;
            continue;
          }
          if(o=='haidaijine'){
            this.ruleForm.haidaijine = obj[o];
	    this.ro.haidaijine = true;
            continue;
          }
          if(o=='haidaishijian'){
            this.ruleForm.haidaishijian = obj[o];
	    this.ro.haidaishijian = true;
            continue;
          }
          if(o=='xuehao'){
	    ...
	    this.ro.xingming = true;
          ...
          if(o=='haidaijindu'){
            this.ruleForm.haidaijindu = obj[o];
	    this.ro.haidaijindu = true;
            continue;
          }
        }
      }
      ...
      this.$http({
		...
		if(json.xingming!=''&&json.xingming){
          ...
          this.$message.error(data.msg);
            ...
            this.haidaijinduOptions = "进行中,已完成".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
        url: `haidaixinxi/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    // 提交
    onSubmit() {
        this.ruleForm.haidaijine = this.haidaijine
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `haidaixinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.haidaixinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
