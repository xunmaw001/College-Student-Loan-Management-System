<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学校电话" prop="xuexiaodianhua">
          <el-input v-model="ruleForm.xuexiaodianhua" 
              placeholder="学校电话" clearable  :readonly="ro.xuexiaodianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学校电话" prop="xuexiaodianhua">
              <el-input v-model="ruleForm.xuexiaodianhua" 
                placeholder="学校电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="学校简介" prop="xuexiaojianjie">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.xuexiaojianjie" label="学校简介" prop="xuexiaojianjie">
                    <span>{{ruleForm.xuexiaojianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	mima : false,
	xuexiaodizhi : false,
	xuexiaodianhua : false,
	xuexiaojianjie : false,
      },
      ruleForm: {
        xuexiaomingcheng: '',
        mima: '',
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xuexiaodizhi = true;
          ...
          if(o=='xuexiaodianhua'){
            this.ruleForm.xuexiaodianhua = obj[o];
	    this.ro.xuexiaodianhua = true;
            continue;
          }
          if(o=='xuexiaojianjie'){
            this.ruleForm.xuexiaojianjie = obj[o];
	    this.ro.xuexiaojianjie = true;
            continue;
          }
        }
      }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xuexiao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xuexiaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
