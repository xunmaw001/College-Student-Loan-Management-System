<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学生电话" prop="xueshengdianhua">
          <el-input v-model="ruleForm.xueshengdianhua" 
              placeholder="学生电话" clearable  :readonly="ro.xueshengdianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学生电话" prop="xueshengdianhua">
              <el-input v-model="ruleForm.xueshengdianhua" 
                placeholder="学生电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
